export const createHtml = (emailToken) => {
  return `<!DOCTYPE html>
<html>
<head>
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://www.blogdesire.com" target="_blank" style="display: inline-block;">
                <img src="https://www.citypng.com/public/uploads/preview/hd-my-hero-academia-logo-png-701751694779763lw50eb9w9i.png" alt="Logo" border="0" width="100" style="display: block; width: 100x; max-width: 100px; min-width: 100px;">
              </a>
            </td>
          </tr>
        </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          ...
                          href='http://127.0.0.1:5500/FE/confirm.html?token=${emailToken}'>Click Me</a>
                        </td>
                      </tr>
                    </table>
                  </td>
